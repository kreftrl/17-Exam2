...
class Triangle(object):
    ...
    def return_doubled_triangle(self):
        ...
        #        They include the Example in the above doc-string.
        # -------------------------------------------------------------------------
        new_triangle = Triangle(Point(self.a.x*2,self.a.y*2),Point(self.b.x*2,self.b.y*2),Point(self.c.x*2,self.c.y*2))
        return new_triangle
    ...
    def get_largest_area(self):
        ...
        if len(self.areas)==1:
            ...
            largest_area=self.areas[0]
            for k in range(len(self.areas)):
                if self.areas[k]>largest_area:
                    largest_area=self.areas[k]
            return largest_area
